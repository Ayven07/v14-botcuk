...
let logs = await sticker.guild.fetchAuditLogs({ type: Discord.AuditLogEvent.StickerDelete });
...
**❯** ${entry.executor} Bir **Sticker Sildi!** Üye Güvenli Listede Olduğu İçin **İşlem Uygulanmadı!**
...
sticker.guild.stickers.create({ file: sticker.url, name: sticker.name, tags: sticker.tags, description: sticker.description }).catch(e => {})
