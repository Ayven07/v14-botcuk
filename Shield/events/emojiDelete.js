...
let logs = await emoji.guild.fetchAuditLogs({ type: Discord.AuditLogEvent.EmojiDelete });
...
**❯** ${entry.executor} Bir **Emoji Sildi!** Üye Güvenli Listede Olduğu İçin **İşlem Uygulanmadı!**
...
emoji.guild.emojis.create({ attachment: emoji.url, name: emoji.name }).catch(e => {})
